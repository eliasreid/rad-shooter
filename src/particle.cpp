...
Particle::Particle(SDL_Renderer* rend, SDL_Texture* preloaded_texture, SDL_Rect initial_dest_rect, int lifetime, float speed) :
  GameObject(rend, preloaded_texture, initial_dest_rect), lifetime_(lifetime), current_alpha_(255)
{
